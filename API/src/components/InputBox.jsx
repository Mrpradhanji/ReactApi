...
function InputBox({
    ...
    const amountInputId =  useId()//useid gives unique key values automatically
    ...
    <div className={`bg-gray-500 p-3 rounded-lg text-sm flex ${className}`}>
        ...
        <div className="w-1/2 flex flex-wrap justify-end text-right">
            ...
            <select 
                ...
                bg-gray-800 cursor-pointer outline-none"
                value={selectCurrency}
                onChange={(e)=>onCurrencyChange && onCurrencyChange(e.target.value)}
                disabled={currencyDisable}
                >
                    {/* remember the key whenever use the react jsx*/}
